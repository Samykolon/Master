...
# Train a 9LSTM-RESNET with a 40-MFCC-Feature + 13-Chroma-Feature dataset (53 Features total)
...
PREMODELNAME = "rnn_full_mfcc+chroma_nopreemph_envnoise_resnet_ws08_512_"
...
while cc < 6:
    ...
    # RESNET
    input1 = layers.Input(shape=(None, 53))
