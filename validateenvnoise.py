...
# Paths
PATH_SOURCE = "/home/smu/Desktop/RNN/audiodata/envnoisevalidation/0_source/"
PATH_TRAINDATA = "/home/smu/Desktop/RNN/audiodata/envnoisevalidation/Time+Spectral/"
PATH_MODELS = "/home/smu/Desktop/RNN/models/"
PATH_VALIDATE = "/home/smu/Desktop/RNN/validate/"

# Name of the model (for saving and logs)
PREMODELNAME = "rnn_full_time+spec_nopreemph_nonoise_resnet_ws08_512"
...
for aud in tqdm(glob.glob("*.wav")):
    ...
    if "W" in aud:
        ...
        emotion = "T"
    featurefile = "../Time+Spectral/" + aud + "_" + emotion
...
f = open("/home/smu/Desktop/RNN/validate/" + PREMODELNAME + "_result.txt", "w")
f.write(names)
f.write("\n\n")
f.write(o_classes)
f.write("\n")
