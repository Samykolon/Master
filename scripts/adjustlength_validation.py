...
# Make all samples of the validation dataset 6 seconds long
...
os.chdir("/home/smu/Desktop/RNN/audiodata/ValidationSET_WAV")
...
for aud in glob.glob("*.wav"):
    ...
    while i < (number_full_wav + 1.0):
        ...
        i += 1.0
    final = final[:6000]
    filepath = "/home/smu/Desktop/RNN/audiodata/ValidationSET_SIX/" + aud
