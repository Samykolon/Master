...
history = model.fit(features_train, ltr, epochs=35, batch_size=128, validation_data=(features_test, ltt), callbacks=[tensorboard_callback])
...
# Modell nur erstes Layer mit Input
# Modelle validiere
# Auswerte-Pipeline
